...
urlpatterns = [
    ...
    url(r'^freports/tasks/change_status$', freports.change_status_task, name='change_status_task'),
    ...
    url(r'^freports/tasks/delete_old/$', freports.delete_old_tasks, name='forensic_delete_old'),
