...
from .contacts import contacts_list, contact_detail, add_contact, edit_contact, delete_contact
...
from .tasks import tasks_list, change_status_task, tasks_today_list, add_task, edit_task, delete_task, delete_old_tasks
